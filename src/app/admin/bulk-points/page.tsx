  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-tcb-gray-400 text-sm mt-1">Input poin untuk beberapa member sekaligus per game. Kolom kosong akan dilewati.</p>
      </div>
      <BulkPointsForm members={members} games={games} />
    </div>
  );
}
