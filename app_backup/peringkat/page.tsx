...
export default async function PeringkatPage({
  ...
  const PODIUM_DISPLAY = [
    { idx: 1, pos: 2, borderColor: "#9ca3af", textColor: "#d1d5db", bgColor: "rgba(156,163,175,0.08)", h: "h-16 sm:h-24" },
    { idx: 0, pos: 1, borderColor: "#E01E2B", textColor: "#E01E2B", bgColor: "rgba(224,30,43,0.08)",   h: "h-24 sm:h-32" },
    { idx: 2, pos: 3, borderColor: "#f59e0b", textColor: "#fbbf24", bgColor: "rgba(245,158,11,0.08)",  h: "h-12 sm:h-20" },
  ];
            ...
            {list.map((player) => {
              ...
              return (
                <Link key={player.id} href={`/member/${player.username}`}
                  ...
                  style={isMe
                    ? { backgroundColor: "rgba(224,30,43,0.08)", borderColor: "#E01E2B" }
